...
export type ColumnRender = "boolean" | "status" | "draftpill" | "readpill" | "image" | "thumb";
...
courses: {
  ...
  icon: "📚",
  columns: [
    { key: "thumbnail_image", label: "Thumbnail", render: "thumb" },
  ...
  fields: [
    ...
    { name: "thumbnail_image", label: "Course Thumbnail", type: "file", hint: "Upload a JPG or PNG (16:9 looks best) — or paste an image URL." },
